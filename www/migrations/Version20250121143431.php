 ...
 */
final class Version20250121143431 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE film (id INT AUTO_INCREMENT NOT NULL, age_id INT DEFAULT NULL, note_id INT DEFAULT NULL, titre VARCHAR(50) NOT NULL, synopsis LONGTEXT NOT NULL, date_sortie DATE NOT NULL, image_path VARCHAR(255) NOT NULL, time VARCHAR(10) NOT NULL, INDEX IDX_8244BE22CC80CD12 (age_id), UNIQUE INDEX UNIQ_8244BE2226ED0855 (note_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
